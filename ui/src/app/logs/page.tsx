    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6 font-mono transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-800 dark:text-slate-150 placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-teal-500 transition-all font-mono"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2 text-sm bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-zinc-800 dark:text-zinc-300 focus:outline-none focus:ring-1 focus:ring-teal-500 focus:border-teal-500 transition-all cursor-pointer font-mono"
            >
          ...
          <div className="flex items-center justify-between gap-2 bg-slate-50 dark:bg-slate-900 px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg text-xs">
            <span className="text-zinc-550 dark:text-zinc-450 font-bold">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="h-7 px-3 bg-white hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-850 border border-slate-200 dark:border-slate-850 rounded text-zinc-650 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-white disabled:opacity-40 disabled:hover:text-zinc-400 cursor-pointer transition-colors text-xs font-bold"
              >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-xs bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-800 dark:text-slate-150 focus:outline-none focus:ring-1 focus:ring-teal-500 shadow-inner font-mono"
                />
              </div>
            </div>
            <div className="space-y-1.5">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-4">
          <div className="flex justify-between items-center bg-white dark:bg-slate-950/40 p-3 border border-slate-200 dark:border-slate-900 rounded-xl">
            ...
            <span className="text-xs px-2.5 py-0.5 bg-slate-50 dark:bg-slate-900 text-zinc-650 dark:text-zinc-500 rounded border border-slate-200 dark:border-slate-800">
          ...
          <div className="space-y-3 pr-1 overflow-y-auto max-h-[70vh]">
            {loading ? (
              ...
              <div className="p-12 border border-dashed border-slate-200 dark:border-slate-900 rounded-2xl text-center text-zinc-500 text-xs leading-relaxed">
                ...
                <div
                  ...
                  className={`p-4 rounded-2xl cursor-pointer transition-all duration-300 border ${
                    activeLog?.id === log.id
                      ...
                      : "bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-900 hover:bg-slate-50 dark:hover:bg-slate-900/30 hover:border-slate-350 dark:hover:border-slate-800 shadow-sm"
                  }`}
                >
                  <div className="flex justify-between items-start gap-2">
                    <span className="inline-flex items-center gap-1.5 text-xs px-2 py-0.5 bg-slate-50 dark:bg-slate-900 text-slate-750 dark:text-slate-300 rounded-md border border-slate-200 dark:border-slate-850 font-semibold shadow-sm">
                      <Folder className="h-3 w-3 text-teal-500" />
                      <span className="text-[10px] uppercase tracking-wider text-zinc-450 dark:text-zinc-550 mr-0.5">Repo:</span>
        ...
        <div className="lg:col-span-3 flex flex-col space-y-4">
          ...
          {activeLog ? (
            <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-900 p-6 rounded-3xl shadow-md space-y-4 animate-fade-in flex flex-col transition-colors">
              <div className="pb-4 border-b border-slate-200 dark:border-slate-900 flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                <div>
                  <h3 className="text-sm font-black uppercase tracking-widest text-teal-650 dark:text-teal-400">Logged Event Details</h3>
                  <div className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-300 rounded-md border border-slate-200 dark:border-slate-800 mt-1.5 font-bold shadow-inner">
                    <Folder className="h-3 w-3 text-teal-500" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-150 dark:border-slate-850 p-4 rounded-xl text-xs font-mono font-bold text-zinc-800 dark:text-zinc-100 whitespace-pre-wrap leading-relaxed shadow-inner">
                  {activeLog.content}
                </div>
              </div>
              ...
              {activeLog.metadata ? (
                <div className="flex flex-col flex-1 space-y-1.5">
                  ...
                  <pre className="bg-slate-50 dark:bg-slate-900/80 border border-slate-150 dark:border-slate-850 p-4 rounded-xl text-xs font-mono text-teal-700 dark:text-teal-400 overflow-x-auto whitespace-pre leading-relaxed shadow-inner max-h-[45vh] scrollbar-thin">
                    <code>{activeLog.metadata}</code>
                  </pre>
                </div>
              ) : (
                <div className="p-6 text-center border border-dashed border-slate-200 dark:border-slate-900 rounded-xl text-zinc-500 text-xs">
                  // No advanced patch code or file stats metadata captured for this event.
                </div>
              )}
            </div>
          ) : (
            <div className="h-80 border border-dashed border-slate-200 dark:border-slate-900 rounded-3xl flex flex-col items-center justify-center text-center p-6 text-zinc-500">
              <span className="text-4xl mb-2">🔍</span>
              <p className="text-sm font-bold">Inspection Terminal Empty</p>
              <p className="text-xs text-zinc-500 dark:text-zinc-450 mt-2 max-w-sm leading-relaxed">Select any log from the left commits ingestion list to inspect file diff changes, branch patches, and tech signatures.</p>
            </div>
          )}
        </div>
